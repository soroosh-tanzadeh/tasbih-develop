package ir.maxivity.tasbih.dataAccess.map;
...
public class UserLocation extends Fragment {
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(UserLocation.this.getActivity(), REQUEST_CODE);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(UserLocation.this.getContext(), errorMessage, Toast.LENGTH_LONG).show();
                        }
    ...
    private void addUserMarker(LngLat loc){
        ...
        markStCr.setBitmap(BitmapUtils.createBitmapFromAndroidBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.ic_location_user)));
